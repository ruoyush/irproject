...
//			corpus = new TrecwebCollection();
		...
		while ((doc = corpus.nextDocument()) != null) {
			...
			// load document content
                        Job temp = (Job) doc.get(docno);
                        String str = temp.getJobTitle()+temp.getCompany()+temp.getSummary();
		...
		System.out.println("totaly document count:  "+count);
                System.out.println("totaly token count:  "+wcount);
		wr.close();
	}
}
